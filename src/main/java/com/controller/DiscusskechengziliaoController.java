...
public class DiscusskechengziliaoController {
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DiscusskechengziliaoEntity discusskechengziliao, HttpServletRequest request){
        EntityWrapper<DiscusskechengziliaoEntity> ew = new EntityWrapper<DiscusskechengziliaoEntity>();
		PageUtils page = discusskechengziliaoService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, discusskechengziliao), params), params));
        return R.ok().put("data", page);
    }
    ...
    public R save(@RequestBody DiscusskechengziliaoEntity discusskechengziliao, HttpServletRequest request){
    	discusskechengziliao.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<DiscusskechengziliaoEntity> wrapper = new EntityWrapper<DiscusskechengziliaoEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = discusskechengziliaoService.selectCount(wrapper);
