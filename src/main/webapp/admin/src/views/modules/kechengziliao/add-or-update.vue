<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="资料编号" prop="ziliaobianhao">
            <el-input v-model="ruleForm.ziliaobianhao" 
                placeholder="资料编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.ziliaobianhao" label="资料编号" prop="ziliaobianhao">
              <el-input v-model="ruleForm.ziliaobianhao" 
                placeholder="资料编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="学科" prop="xueke">
          <el-select v-model="ruleForm.xueke" placeholder="请选择学科">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="学科" prop="xueke">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="课程名称" prop="kechengmingcheng">
          <el-select v-model="ruleForm.kechengmingcheng" placeholder="请选择课程名称">
            <el-option
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="文件说明" prop="wenjianshuoming">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.wenjianshuoming" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.wenjianshuoming" label="文件说明" prop="wenjianshuoming">
                    <span v-html="ruleForm.wenjianshuoming"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fengmian = true;
          ...
          if(o=='wenjianshuoming'){
            this.ruleForm.wenjianshuoming = obj[o];
	    this.ro.wenjianshuoming = true;
            continue;
          }
	...
	this.ruleForm.wenjianshuoming = this.ruleForm.wenjianshuoming.replace(reg,'../../../ssm3n87r/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
