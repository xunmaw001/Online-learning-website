<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="学科名称" prop="xuekemingcheng">
          <el-select v-model="ruleForm.xuekemingcheng" placeholder="请选择学科名称">
            <el-option
                v-for="(item,index) in xuekemingchengOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="视频介绍" prop="shipinjieshao">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shipinjieshao" label="视频介绍" prop="shipinjieshao">
                    <span v-html="ruleForm.shipinjieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.shipinjieshao = this.ruleForm.shipinjieshao.replace(reg,'../../../ssm3n87r/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
