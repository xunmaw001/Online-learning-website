<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="学科编号" prop="xuekebianhao">
            <el-input v-model="ruleForm.xuekebianhao" 
                placeholder="学科编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.xuekebianhao" label="学科编号" prop="xuekebianhao">
              <el-input v-model="ruleForm.xuekebianhao" 
                placeholder="学科编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="学科名称" prop="xuekemingcheng">
          <el-input v-model="ruleForm.xuekemingcheng" 
              placeholder="学科名称" clearable  :readonly="ro.xuekemingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="学科名称" prop="xuekemingcheng">
              <el-input v-model="ruleForm.xuekemingcheng" 
                placeholder="学科名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
    ...
    return {
      ...
      ro:{
	xuekebianhao : false,
	xuekemingcheng : false,
	chuangjianshijian : false,
      },
      ruleForm: {
        xuekebianhao: this.getUUID(),
        xuekemingcheng: '',
        chuangjianshijian: '',
      },
      rules: {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='xuekebianhao'){
            this.ruleForm.xuekebianhao = obj[o];
	    this.ro.xuekebianhao = true;
            continue;
          }
          if(o=='xuekemingcheng'){
            this.ruleForm.xuekemingcheng = obj[o];
	    this.ro.xuekemingcheng = true;
            continue;
          }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `xuekexinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xuekexinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
